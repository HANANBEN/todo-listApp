...
import { deleteTodo } from "../../redux/todoReducer/action";
...
return (
  ...
  <div className=" relative place-items-center min-h-screen mt-10 border-purple-500  " >
    ...
    onClick={this.props.AddTodo}>Add to do</button>
     {
    ...
    (this.props.todos || []).map(todo => {
        ...
        >
        <Todo  key={todo.id} deleteTodo={this.props.deleteTodo}   updateTodo={this.updateTodo} label={todo.label}  etat={todo.etat} id={todo.id}  />
        </div>
        )
